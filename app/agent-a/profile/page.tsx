    ...
    <div>
      ...
      <Box>
        <div className="grid place-items-center">
          ...
          <div className="text-sm text-neutral3 mb-4">Agent code</div>
          <div className="text-sm text-primary-orange p-2 flex items-center space-x-2 bg-[#FF74340D] rounded-lg">
            {" "}
            <span>BCJESU093</span>
            <Share2 size={18} color="#fc5900" />{" "}
          </div>
        </div>
      </Box>
      <Box>
